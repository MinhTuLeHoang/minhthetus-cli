...
### Added
- Added project navigate-link command to manage and launch project tool links

## [1.9.1] - 2026-09-16

### Changed
- Detect default main branch from origin/HEAD dynamically and check source branch before inputting branch options during checkout

## [1.9.0] - 2026-09-15

### Added
- Add rebase-master command to rebase onto origin/HEAD with conflict safety checks and force-push
...
### Changed
- Configure Release Tagger workflow to use WIKI_SYNC_TOKEN PAT for tag push, enabling downstream auto-triggers
...
### Added
- Added git rename-branch command to safely rename local and remote Git branches

## [1.6.0] - 2026-07-27

### Added
- Interactive sys host command for managing /etc/hosts with search, edit, and auto-sort capabilities

## [1.5.3] - 2026-07-16

### Added
- Added sys host command to manage the system host file (/etc/hosts) interactively.

### Changed
- Unified isDevMode flag into a centralized config package using Go build tags.

### Removed
- Removed clean-log and push-log commands under the sys namespace.
